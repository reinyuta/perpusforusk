                ...
                <div class="card-body">
                    <p class="mb-0">
                        ...
                        <div class="card-header">
                            <h2>DAFTAR BUKU<br>
                             <a class="btn btn-primary btn-md" href="/buku/create">Tambah                            </a>
                            </h2>
                            </div>
                            ...
                            <div class="col">
                                <div class="card" style="height: 22rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="btn-group">
                                            <a class="btn btn-warning" href="/buku/edit/{{$buku->id}}">
                                            <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <a class="btn btn-danger" onclick="return confirm('yakin mau hapus data ini?');" href="/buku/{{$buku->id}}">
