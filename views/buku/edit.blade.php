    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <p class="mb-0">
                        <h2><font color="blue">UBAH BUKU</font></h2>
                        <div class="card-body">
                            <form class="form-horizontal" action="/buku/{{$ubah->id}}" method="POST" enctype="multipart/form-data">
                               @method('PUT')
                                @csrf
                                <div class="form-group">
                                    <label for="id_buku" class="col-sm-2 control-label">Id Buku</label>
                                    <div class="col-sm-3">
                                        <input type="text" name="id_buku" class="form-control" value="{{$ubah->id_buku}}"  >
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="judul" class="form-control" value="{{$ubah->id_buku}}" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="penulis" class="col-sm-2 control-label">Penulis</label>
                                    <div class="col-sm-5">
                                        <input type="text" name="penulis" class="form-control" value="{{$ubah->penulis}}" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="penerbit" class="col-sm-2 control-label">Penerbit</label>
                                    <div class="col-sm-5">
                                        <input type="text" name="penerbit" class="form-control" value="{{$ubah->penerbit}}" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="tahun_terbit" class="col-sm-2 control-label">Tahun Terbit</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="tahun_terbit" class="form-control" value={{$ubah->tahun_terbit}}"" >
                                    </div>
                                </div>
                                <div class="form-group">
